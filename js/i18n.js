(function(){
  const I18N = {
    pt: {
      ...
      c1d_p1: "Eu cuidava do dinheiro dos doze. Pensa nisso antes de me chamar de ladrão. Ninguém entrega a bolsa a um homem em quem já não confia. Eles entregaram.",
      c1d_p2: "Por anos fui eu que comprei o pão, paguei o teto, separei o que sobrava para os pobres. Ninguém contava as moedas atrás de mim.",
      c1d_p3: "Depois, foi fácil me reduzir à pior coisa que fiz. Mas antes de eu virar explicação para o horror, eu fui alguém a quem se entregavam coisas. Dinheiro. Recados. Silêncios.",
      c1d_p4: "Talvez tenha sido por isso que, quando veio o pedido maior, ele soube que eu não largaria no chão.",

      c2_title: "O perfume",
      c2_teaser: "Reclamei do perfume derramado. Foi essa frase que pregaram em mim.",
      c2d_idx: "Prova II",
      c2d_title: "O perfume",
      c2d_p1: "Custava quase um ano de trabalho. Trezentos denários, disseram depois, como se alguém naquela casa não tivesse feito a conta em silêncio.",
      c2d_p2: "Ela quebrou o frasco e derramou tudo nos pés dele. O cheiro tomou a sala inteira: doce, pesado, quase fúnebre.",
      c2d_p3: "Eu falei. Disse que aquilo podia ter sido vendido, que dava para alimentar muita gente. Talvez fosse piedade. Talvez cálculo. Talvez eu já não soubesse separar uma coisa da outra.",
      c2d_p4: "Depois fizeram da minha frase uma alma inteira.",
      c2d_p5: "Só sei que, naquela noite, antes do beijo, eu vi perfume escorrendo como riqueza sobre pés cansados. Não pensei em prata. Pensei em pão.",

      c3_title: "O pão",
      c3_teaser: "Na ceia, ele molhou o pão e me entregou. \"Faça logo.\"",
      c3d_idx: "Prova III",
      c3d_title: "O pão",
      c3d_p1: "Ele sabia. Antes de qualquer um na mesa, ele já sabia.",
      c3d_p2: "Mesmo assim, molhou o pão e colocou na minha mão. \"O que você tem para fazer, faça logo.\" Os outros acharam que era recado sobre comida, sobre a bolsa, sobre alguma obrigação pequena.",
      c3d_p3: "Eu entendi.",
      c3d_p4: "Aquilo não era recado. Era entrega. Ele colocava nas minhas mãos o começo do fim que dizia precisar atravessar.",
      c3d_p5: "Não levantei por cobiça. Levantei porque a ordem veio de quem eu tinha seguido até ali.",
      c3d_p6: "Saí para o escuro com o pão ainda na boca. Ninguém me segurou. Às vezes penso que, se alguém tivesse perguntado para onde eu ia, eu teria ficado.",

      c4_title: "A noite",
      c4_teaser: "Esperei no jardim com os soldados, sabendo o que ia fazer.",
      c4d_idx: "Prova IV",
      c4d_title: "A noite",
      c4d_p1: "Fiquei no escuro com homens armados que não conheciam o rosto dele. Eu conhecia. Era para isso que eu servia ali: ser os olhos deles. Tinham cordas, lâminas, ordens, pressa. Mas não tinham o rosto.",
      c4d_p2: "Sem mim, eram só homens procurando no escuro alguém que eu amava.",
      c4d_p3: "Tive tempo de desistir. Esse foi o pior castigo: ter tido tempo. Cada segundo era uma porta aberta para eu virar e ir embora. Eu quis. Cada parte de mim quis.",
      c4d_p4: "Mas fugir não era só me salvar. Era largar no escuro aquilo que ele tinha posto nas minhas mãos. Era fazer falhar a coisa que ele disse que precisava acontecer.",

      c5_title: "O beijo",
      c5_teaser: "Um beijo. Era o sinal combinado. A última vez que toquei nele.",
      c5d_idx: "Prova V",
      c5d_title: "O beijo",
      c5d_p1: "Combinamos que seria um beijo. Eu podia ter apontado. Podia ter dito o nome em voz alta. Podia ter escolhido um gesto sem pele, sem calor, sem memória.",
      c5d_p2: "Mas foi um beijo.",
      c5d_p3: "Porque ainda era amor. Porque talvez só o amor obedecesse a um pedido daqueles.",
      c5d_p4: "Encostei o rosto no dele e senti a barba, o calor, a calma de quem já sabia de tudo. Ele me chamou de amigo. Naquele instante. Com os homens chegando.",
      c5d_p5: "Carrego esse \"amigo\" faz dois mil anos.",
      c5d_p6: "Pesa mais que a prata, mais que a corda, mais que o nome que me deram depois. Eu fiz porque era ele. Porque foi ele que pediu. Porque acreditei que até aquilo precisava caber no amor que eu tinha por ele.",
    ...
    en: {
      ...
      c1d_idx: "Exhibit I",
      c1d_title: "The trust",
      c1d_p1: "I kept the money for the twelve of us. Think about that before you call me a thief. No one hands the purse to a man they no longer trust. They handed it to me.",
      c1d_p2: "For years I bought the bread, paid for the roof, set aside what was left for the poor. No one counted the coins behind my back.",
      c1d_p3: "Afterward, it was easy to reduce me to the worst thing I did. But before I became an explanation for the horror, I was someone things were entrusted to. Money. Messages. Silences.",
      c1d_p4: "Maybe that was why, when the greater request came, he knew I would not drop it on the ground.",
      ...
      c2d_p1: "It cost almost a year's work. Three hundred denarii, they said later, as if anyone in that house had not done the math in silence.",
      c2d_p2: "She broke the jar and poured everything over his feet. The smell filled the whole room: sweet, heavy, almost funereal.",
      c2d_p3: "I spoke. I said it could have been sold, that it could have fed many people. Maybe it was pity. Maybe calculation. Maybe I no longer knew how to separate one thing from the other.",
      c2d_p4: "Later they made one sentence into an entire soul.",
      c2d_p5: "All I know is that, that night, before the kiss, I saw perfume running like wealth over tired feet. I did not think of silver. I thought of bread.",

      c3_title: "The bread",
      c3_teaser: "At the supper, he dipped the bread and handed it to me. \"Do it quickly.\"",
      c3d_idx: "Exhibit III",
      c3d_title: "The bread",
      c3d_p1: "He knew. Before anyone else at the table, he already knew.",
      c3d_p2: "Even so, he dipped the bread and placed it in my hand. \"What you have to do, do quickly.\" The others thought it was about food, about the purse, about some small duty.",
      c3d_p3: "I understood.",
      c3d_p4: "That was not an errand. It was a handing over. He was placing in my hands the beginning of the end he said he had to cross.",
      c3d_p5: "I did not rise out of greed. I rose because the order came from the one I had followed this far.",
      c3d_p6: "I walked out into the dark with the bread still in my mouth. No one stopped me. Sometimes I think that, if anyone had asked where I was going, I would have stayed.",

      c4_title: "The night",
      c4_teaser: "I waited in the garden with the soldiers, knowing what I was about to do.",
      c4d_idx: "Exhibit IV",
      c4d_title: "The night",
      c4d_p1: "I stood in the dark with armed men who did not know his face. I did. That was what I was there for: to be their eyes. They had ropes, blades, orders, urgency. But they did not have the face.",
      c4d_p2: "Without me, they were only men searching in the dark for someone I loved.",
      c4d_p3: "I had time to turn back. That was the worst punishment: having had the time. Every second was an open door for me to turn and walk away. I wanted to. Every part of me wanted to.",
      c4d_p4: "But fleeing was not only saving myself. It was leaving in the dark what he had placed in my hands. It was making fail the thing he said had to happen.",

      c5_title: "The kiss",
      c5_teaser: "A kiss. That was the signal we agreed on. The last time I ever touched him.",
      c5d_idx: "Exhibit V",
      c5d_title: "The kiss",
      c5d_p1: "We agreed it would be a kiss. I could have pointed. I could have said the name aloud. I could have chosen a gesture without skin, without warmth, without memory.",
      c5d_p2: "But it was a kiss.",
      c5d_p3: "Because it was still love. Because perhaps only love would obey a request like that.",
      c5d_p4: "I pressed my face to his and felt the beard, the warmth, the calm of someone who already knew everything. He called me friend. In that instant. With the men closing in.",
      c5d_p5: "I have carried that \"friend\" for two thousand years.",
      c5d_p6: "It weighs more than the silver, more than the rope, more than the name they gave me afterward. I did it because it was him. Because he was the one who asked. Because I believed that even that had to fit inside the love I had for him.",
      ...
      colophon: "made by Henrique Guimarães",
